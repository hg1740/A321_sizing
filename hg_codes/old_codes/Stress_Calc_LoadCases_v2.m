...
function [Von_skn, Von_spr, sigmab_skn, taub_skn, sigma_pp, sigma_strg, sigma_crip, sigma_col]=Stress_Calc_LoadCases_v2(x,Semi_span,Root_chord,LE_sweep,TE_sweep,BeamLoc,Fuselage_length, Wing_position, Horizontal_tail_position, Vertical_tail_position, Secondary_mass,Fuel_mass,Fuselage_total_mass)
...
%     delete('D:\MATLAB_workspace\ALENA-master\ALENA-master\hg_codes\Sizing_analysis\Result\A320_half_model_SOL144*.*')
    ...
    GustLoadcase1.GustLength = linspace(18,214,10);%[18:20:214];
    ...
    GustLoadcase2.GustLength = linspace(18,214,10);%[18:20:214];
    ...
    GustLoadcase3.GustLength = linspace(18,214,10);%[18:20:214];
    ...
    %% Gust analysis Case 4 : 36000ft,  - 1MC
    
    GustLoadcase4 = awi.model.LoadCase;
    %     GustLoadcase.LoadCaseType = 'Pratt Gust';
    GustLoadcase4.Altitude   = 36000;
    GustLoadcase4.AcVelocity = 0.78*340;
    GustLoadcase4.AcMass = 500;
    GustLoadcase4.Mach = 0.78;
    GustLoadcase4.GustLength = linspace(18,214,10);%[18:20:214];
    
    % Gust direction: positive or negative hit
    GustLoadcase4.GustDirection=-1;
    
    FlightPoint4=awi.model.FlightPoint;
    FlightPoint4.Mach=0.78;
    FlightPoint4.AcVelocity=FlightPoint4.Mach*340;
    FlightPoint4.Altitude = 36000;
    getFlightPointData(FlightPoint4,'ISA');
    
    NastranMethods1 = awi.methods.Nastran;
    NastranMethods1.AnalysisModel = FEM_full;
    MassCases=awi.model.MassCases.empty;
    
    gustfile4=NastranMethods1.writeGustFile(Aircraft, GustLoadcase4, MassCases, FlightPoint4, run_folder,'DatFilename','gust_analysis_g_36000ft_neg_1MC');
    
    NastranMethods1.runNastran(gustfile4);
    
    %% Gust analysis Case 5 : 20000ft, - 1MC
    
    GustLoadcase5 = awi.model.LoadCase;
    %     GustLoadcase.LoadCaseType = 'Pratt Gust';
    GustLoadcase5.Altitude   = 20000;
    GustLoadcase5.AcVelocity = 0.6*340;
    GustLoadcase5.AcMass = 500;
    GustLoadcase5.Mach = 0.6;
    GustLoadcase5.GustLength = linspace(18,214,10);%[18:20:214];
    
    % Gust direction: positive or negative hit
    GustLoadcase5.GustDirection=-1;
    
    FlightPoint5=awi.model.FlightPoint;
    FlightPoint5.Mach=0.6;
    FlightPoint5.AcVelocity=FlightPoint5.Mach*340;
    FlightPoint5.Altitude = 20000;
    getFlightPointData(FlightPoint5,'ISA');
    
    NastranMethods1 = awi.methods.Nastran;
    NastranMethods1.AnalysisModel = FEM_full;
    MassCases=awi.model.MassCases.empty;
    
    gustfile5=NastranMethods1.writeGustFile(Aircraft, GustLoadcase5, MassCases, FlightPoint5, run_folder,'DatFilename','gust_analysis_g_20000ft_neg_1MC');
    
    NastranMethods1.runNastran(gustfile5);
    
    %% Gust analysis Case 6 : sea level,  - 1MC
    
    GustLoadcase6 = awi.model.LoadCase;
    %     GustLoadcase.LoadCaseType = 'Pratt Gust';
    GustLoadcase6.Altitude   = 3000;
    GustLoadcase6.AcVelocity = 0.48*340;
    GustLoadcase6.AcMass = 500;
    GustLoadcase6.Mach = 0.48;
    GustLoadcase6.GustLength = linspace(18,214,10);%[18:20:214];
    
    % Gust direction: positive or negative hit
    GustLoadcase6.GustDirection=-1;
    
    FlightPoint6=awi.model.FlightPoint;
    FlightPoint6.Mach=0.48;
    FlightPoint6.AcVelocity=FlightPoint6.Mach*340;
    FlightPoint6.Altitude = 3000;
    getFlightPointData(FlightPoint6,'ISA');
    
    NastranMethods1 = awi.methods.Nastran;
    NastranMethods1.AnalysisModel = FEM_full;
    MassCases=awi.model.MassCases.empty;
    
    gustfile6=NastranMethods1.writeGustFile(Aircraft, GustLoadcase6, MassCases, FlightPoint6, run_folder,'DatFilename','gust_analysis_g_3000ft_neg_1MC');
    
    NastranMethods1.runNastran(gustfile6);
    ...
    [Max_Moment_LC1,Min_Moment_LC1, Max_Torque_LC1, Min_Torque_LC1, Max_Shear_LC1, Min_Shear_LC1]=Gust_peaks(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_36000ft_pos_1MC.h5',NumSteps)
    [Max_Moment_LC2,Min_Moment_LC2, Max_Torque_LC2, Min_Torque_LC2, Max_Shear_LC2, Min_Shear_LC2]=Gust_peaks(WingNodes,GustLoadcase2,run_folder,'\gust_analysis_g_20000ft_pos_1MC.h5',NumSteps)
    [Max_Moment_LC3,Min_Moment_LC3, Max_Torque_LC3, Min_Torque_LC3, Max_Shear_LC3, Min_Shear_LC3]=Gust_peaks(WingNodes,GustLoadcase3,run_folder,'\gust_analysis_g_3000ft_pos_1MC.h5',NumSteps)
    [Max_Moment_LC4,Min_Moment_LC4, Max_Torque_LC4, Min_Torque_LC4, Max_Shear_LC4, Min_Shear_LC4]=Gust_peaks(WingNodes,GustLoadcase4,run_folder,'\gust_analysis_g_36000ft_neg_1MC.h5',NumSteps)
    [Max_Moment_LC5,Min_Moment_LC5, Max_Torque_LC5, Min_Torque_LC5, Max_Shear_LC5, Min_Shear_LC5]=Gust_peaks(WingNodes,GustLoadcase5,run_folder,'\gust_analysis_g_20000ft_neg_1MC.h5',NumSteps)
    [Max_Moment_LC6,Min_Moment_LC6, Max_Torque_LC6, Min_Torque_LC6, Max_Shear_LC6, Min_Shear_LC6]=Gust_peaks(WingNodes,GustLoadcase6,run_folder,'\gust_analysis_g_3000ft_neg_1MC.h5',NumSteps)
    ...
    Moment_P2_Loadcase7=abs(Trim4.M_P2) + abs([Max_Moment_LC4; 0]');
    Torque_Loadcase7=abs(Trim4.T) + abs([Min_Torque_LC4; 0]');
    Shear_P1_Loadcase7=abs(Trim4.S_P1);
    Shear_P2_Loadcase7=abs(Trim4.S_P2) + abs([Max_Shear_LC4; 0]');
    
    % Load case 8: 20000ft g and - 1MC
    Moment_P1_Loadcase8=abs(Trim5.M_P1);
    Moment_P2_Loadcase8=abs(Trim5.M_P2) + abs([Max_Moment_LC5; 0]');
    Torque_Loadcase8=abs(Trim5.T) + abs([Max_Torque_LC5; 0]');
    Shear_P1_Loadcase8=abs(Trim5.S_P1);
    Shear_P2_Loadcase8=abs(Trim5.S_P2) +  abs([Max_Shear_LC5; 0]');
    
    % Load case 9: 3000ft g and - 1MC
    Moment_P1_Loadcase9=abs(Trim6.M_P1);
    Moment_P2_Loadcase9=abs(Trim6.M_P2) + abs([Max_Moment_LC6; 0]');
    Torque_Loadcase9=abs(Trim6.T) + abs([Max_Torque_LC6; 0]');
    Shear_P1_Loadcase9=abs(Trim6.S_P1);
    Shear_P2_Loadcase9=abs(Trim6.S_P2) + abs([Max_Shear_LC6; 0]');
...
%     
%     figure 
%     plot(Y-2,Shear_P2_Loadcase1,'rs','MarkerFaceColor','r')
%     hold on
%     plot(Y-2,Shear_P2_Loadcase2,'bs','MarkerFaceColor','b')
%     hold on
%     plot(Y-2,Shear_P2_Loadcase3,'ks','MarkerFaceColor','k')
%     hold on
%     plot(Y-2,Shear_P2_Loadcase4,'r-','LineWidth',0.8)
%     hold on
%     plot(Y-2,Shear_P2_Loadcase5,'b--','LineWidth',0.8)
%     hold on
%     plot(Y-2,Shear_P2_Loadcase6,'k-.','LineWidth',0.8)
%     hold on
%     plot(Y-2,Shear_P2_Loadcase7,'ro','MarkerFaceColor','r')
%     hold on
%     plot(Y-2,Shear_P2_Loadcase8,'bo','MarkerFaceColor','b')
%     hold on
%     plot(Y-2,Shear_P2_Loadcase9,'ko','MarkerFaceColor','k')
% %     hold on
...
%     figure 
%     plot(Y-2,Moment_P2_Loadcase1,'rs','MarkerFaceColor','r')
%     hold on
%     plot(Y-2,Moment_P2_Loadcase2,'bs','MarkerFaceColor','b')
%     hold on
%     plot(Y-2,Moment_P2_Loadcase3,'ks','MarkerFaceColor','k')
%     hold on
%     plot(Y-2,Moment_P2_Loadcase4,'r-','LineWidth',0.8)
%     hold on
%     plot(Y-2,Moment_P2_Loadcase5,'b--','LineWidth',0.8)
%     hold on
%     plot(Y-2,Moment_P2_Loadcase6,'k-.','LineWidth',0.8)
%     hold on
%     plot(Y-2,Moment_P2_Loadcase7,'ro','MarkerFaceColor','r')
%     hold on
%     plot(Y-2,Moment_P2_Loadcase8,'bo','MarkerFaceColor','b')
%     hold on
%     plot(Y-2,Moment_P2_Loadcase9,'ko','MarkerFaceColor','k')
% %     hold on
% %     plot(Y-2,S_P2,'r--','LineWidth',1.2)
%     
% %     legend('2.5 g','2.5 g','-g ','g + 1MC','g + 1MC', 'g + 1MC','g - 1MC','g - 1MC', 'g - 1MC','Interpreter','latex','FontSize',10)
...
% 
%     figure 
%     plot(Y-2,Torque_Loadcase1,'r-s','MarkerFaceColor','r')
%     hold on
%     plot(Y-2,Torque_Loadcase2,'b-s','MarkerFaceColor','b')
%     hold on
%     plot(Y-2,Torque_Loadcase3,'k-s','MarkerFaceColor','k')
%     hold on
%     plot(Y-2,Torque_Loadcase4,'r-','LineWidth',0.8)
%     hold on
%     plot(Y-2,Torque_Loadcase5,'b--','LineWidth',0.8)
%     hold on
%     plot(Y-2,Torque_Loadcase6,'k-.','LineWidth',0.8)
%     hold on
%     plot(Y-2,Torque_Loadcase7,'--ro','MarkerFaceColor','r')
%     hold on
%     plot(Y-2,Torque_Loadcase8,'--bo','MarkerFaceColor','b')
%     hold on
%     plot(Y-2,Torque_Loadcase9,'--ko','MarkerFaceColor','k')
% %     hold on
% %     plot(Y-2,S_P2,'r--','LineWidth',1.2)
%     
% %     legend('2.5 g','2.5 g','-g ','g + 1MC','g + 1MC', 'g + 1MC','g - 1MC','g - 1MC', 'g - 1MC','Interpreter','latex','FontSize',10)
...
%     hold on
%     
%     plot(Y(1:24)-2,Max_Shear_LC4,'k-.','LineWidth',0.8)
%     hold on
%     plot(Y(1:24)-2,Max_Shear_LC5,'b-.','LineWidth',0.8)
%     hold on
%     plot(Y(1:24)-2,Max_Shear_LC6,'r-.','LineWidth',0.8)
%     
%     hold on 
%     
...
%     hold on
%     
%     plot(Y(1:24)-2,Min_Shear_LC4,'k-.','LineWidth',0.8)
%     hold on
%     plot(Y(1:24)-2,Min_Shear_LC5,'b-.','LineWidth',0.8)
%     hold on
%     plot(Y(1:24)-2,Min_Shear_LC6,'r-.','LineWidth',0.8)
%     
%     xlabel('Span distance (m)','FontSize',12,'Interpreter','latex')
...
%     legend('36 kft +1MC','20 kft +1MC','3 ~ kft +1MC','36 kft -1MC','20 kft -1MC','3 ~ kft -1MC','Interpreter','latex','FontSize',12)
% 
%     axis([0 16 -2.5e5 2.5e5]);

% [Moment_LC1, Torque_LC1, Shear_LC1]=Gust_Thistory(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_36000ft_pos_1MC.h5',NumSteps);
% [Moment_LC2, Torque_LC2, Shear_LC2]=Gust_Thistory(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_20000ft_pos_1MC.h5',NumSteps);
% [Moment_LC3, Torque_LC3, Shear_LC3]=Gust_Thistory(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_3000ft_pos_1MC.h5',NumSteps);
% [Moment_LC4, Torque_LC4, Shear_LC4]=Gust_Thistory(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_36000ft_neg_1MC.h5',NumSteps);
% [Moment_LC5, Torque_LC5, Shear_LC5]=Gust_Thistory(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_20000ft_neg_1MC.h5',NumSteps);
% [Moment_LC6, Torque_LC6, Shear_LC6]=Gust_Thistory(WingNodes,GustLoadcase1,run_folder,'\gust_analysis_g_3000ft_neg_1MC.h5',NumSteps);
% 
% t=linspace(0,2,NumSteps);
% 
% figure 
% plot(t,Moment_LC1(:,1),'b.')
% hold on
% plot(t,Moment_LC1(:,2),'b.')  
% hold on
% plot(t,Moment_LC1(:,3),'b.')
% hold on
% plot(t,Moment_LC1(:,4),'b.')
% hold on
% plot(t,Moment_LC1(:,5),'b.')
% hold on
% plot(t,Moment_LC1(:,6),'b.')
% hold on
% plot(t,Moment_LC1(:,7),'b.')
% hold on
% plot(t,Moment_LC1(:,8),'b.')
% hold on
% plot(t,Moment_LC1(:,9),'b.')
% hold on
% plot(t,Moment_LC1(:,10),'b.')
% 
% figure 
% plot(t,Moment_LC4(:,1),'b.')
% hold on
% plot(t,Moment_LC4(:,2),'b.')  
% hold on
% plot(t,Moment_LC4(:,3),'b.')
% hold on
% plot(t,Moment_LC4(:,4),'b.')
% hold on
% plot(t,Moment_LC4(:,5),'b.')
% hold on
% plot(t,Moment_LC4(:,6),'b.')
% hold on
% plot(t,Moment_LC4(:,7),'b.')
% hold on
% plot(t,Moment_LC4(:,8),'b.')
% hold on
% plot(t,Moment_LC4(:,9),'b.')
% hold on
% plot(t,Moment_LC4(:,10),'b.')

% potato plot
% figure
% M_total1=[Moment_LC1(:,1);Moment_LC1(:,2);Moment_LC1(:,3);Moment_LC1(:,4);Moment_LC1(:,5);Moment_LC1(:,6);Moment_LC1(:,7);Moment_LC1(:,8);Moment_LC1(:,9);Moment_LC1(:,10)];
% T_total1=[Torque_LC1(:,1);Torque_LC1(:,2);Torque_LC1(:,3);Torque_LC1(:,4);Torque_LC1(:,5);Torque_LC1(:,6);Torque_LC1(:,7);Torque_LC1(:,8);Torque_LC1(:,9);Torque_LC1(:,10)];
% P1=[M_total1,T_total1];
% 
% M_total2=[Moment_LC2(:,1);Moment_LC2(:,2);Moment_LC2(:,3);Moment_LC2(:,4);Moment_LC2(:,5);Moment_LC2(:,6);Moment_LC2(:,7);Moment_LC2(:,8);Moment_LC2(:,9);Moment_LC1(:,10)];
% T_total2=[Torque_LC2(:,1);Torque_LC2(:,2);Torque_LC2(:,3);Torque_LC2(:,4);Torque_LC2(:,5);Torque_LC2(:,6);Torque_LC2(:,7);Torque_LC2(:,8);Torque_LC2(:,9);Torque_LC2(:,10)];
% P2=[M_total2,T_total2];
% 
% M_total3=[Moment_LC3(:,1);Moment_LC3(:,2);Moment_LC3(:,3);Moment_LC3(:,4);Moment_LC3(:,5);Moment_LC3(:,6);Moment_LC3(:,7);Moment_LC3(:,8);Moment_LC3(:,9);Moment_LC3(:,10)];
% T_total3=[Torque_LC3(:,1);Torque_LC3(:,2);Torque_LC3(:,3);Torque_LC3(:,4);Torque_LC3(:,5);Torque_LC3(:,6);Torque_LC3(:,7);Torque_LC3(:,8);Torque_LC3(:,9);Torque_LC3(:,10)];
% P3=[M_total3,T_total3];
% 
% M_total4=[Moment_LC4(:,1);Moment_LC4(:,2);Moment_LC4(:,3);Moment_LC4(:,4);Moment_LC4(:,5);Moment_LC4(:,6);Moment_LC4(:,7);Moment_LC4(:,8);Moment_LC4(:,9);Moment_LC4(:,10)];
% T_total4=[Torque_LC4(:,1);Torque_LC4(:,2);Torque_LC4(:,3);Torque_LC4(:,4);Torque_LC4(:,5);Torque_LC4(:,6);Torque_LC4(:,7);Torque_LC4(:,8);Torque_LC4(:,9);Torque_LC4(:,10)];
% P4=[M_total4,T_total4];
% 
% M_total5=[Moment_LC5(:,1);Moment_LC5(:,2);Moment_LC5(:,3);Moment_LC5(:,4);Moment_LC5(:,5);Moment_LC5(:,6);Moment_LC5(:,7);Moment_LC5(:,8);Moment_LC5(:,9);Moment_LC5(:,10)];
% T_total5=[Torque_LC5(:,1);Torque_LC5(:,2);Torque_LC5(:,3);Torque_LC5(:,4);Torque_LC5(:,5);Torque_LC5(:,6);Torque_LC5(:,7);Torque_LC5(:,8);Torque_LC5(:,9);Torque_LC5(:,10)];
% P5=[M_total5,T_total5];
% 
% M_total6=[Moment_LC6(:,1);Moment_LC6(:,2);Moment_LC6(:,3);Moment_LC6(:,4);Moment_LC6(:,5);Moment_LC6(:,6);Moment_LC6(:,7);Moment_LC6(:,8);Moment_LC6(:,9);Moment_LC6(:,10)];
% T_total6=[Torque_LC6(:,1);Torque_LC6(:,2);Torque_LC6(:,3);Torque_LC6(:,4);Torque_LC6(:,5);Torque_LC6(:,6);Torque_LC6(:,7);Torque_LC6(:,8);Torque_LC6(:,9);Torque_LC6(:,10)];
% P6=[M_total6,T_total6];
% 
% 
% [k1,av1] = convhull(P1);
% [k2,av2] = convhull(P2);
...
% [k6,av6] = convhull(P6);
% 
% plot(P1(k1,1),-P1(k1,2),'k-','LineWidth',1)
% hold on 
% plot(P2(k2,1),-P2(k2,2),'b-','LineWidth',1)
% hold on 
% plot(P3(k3,1),-P3(k3,2),'r-','LineWidth',1)
% hold on 
% plot(P4(k4,1),-P4(k4,2),'k--','LineWidth',1)
% hold on 
% plot(P5(k5,1),-P5(k5,2),'b--','LineWidth',1)
% hold on 
% plot(P6(k6,1),-P6(k6,2),'r--','LineWidth',1)
% 
