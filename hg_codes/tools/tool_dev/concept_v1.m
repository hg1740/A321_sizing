...
function Param=concept_v1

 
Param.Wing.AR=14;

Param.Wing.Root_Chord=4.17;

% spar
Param.Wing.CapEta_width=0.05;
...
Param.Wing.Skin_String.Skin_Thickness=0.005*ones(1,25);
...
% skin-stringer panels 
Param.FWT.Skin_String.Skin_Thickness=0.005*ones(1,11);

Param.FWT.Skin_String.Effective_Width=0.005*ones(1,11);

Param.FWT.Skin_String.Strg_Depth=0.005*ones(1,11);

Param.FWT.Skin_String.StrgFlange_Width=0.005*ones(1,11);

Param.FWT.Skin_String.StrgGround_Width=0.005*ones(1,11);
