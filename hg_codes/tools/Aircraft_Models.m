function [Aircraft, FEM_full, Wingbox_right, Box_dimensions, Box_CrossSec, Y_eta, varargout]=Aircraft_Models(Param)
...
%     Connector_left.NSI = Connector_box_left.NSI;
  ...
  %% Wingbox 1 - right and control surf.
    ...
    if isfield(Param,'FWT') 
        ...
        Wingbox_right.Twist = 1*deg2rad([0, 0]);
        ...
        FWT_box_root.Height=Param.FWT.Root_Height;
        FWT_box_root.Width=0.5*Param.FWT.Root_Chord;
        
        FWT_box_root.CoverThickness=Param.FWT.Thickness;
        FWT_box_root.SparThickness=Param.FWT.Thickness;
        
        getGeometricProps(FWT_box_root)
        
        FWT_box_tip=awi.model.BoxBeam;
        FWT_box_tip.BoxType='SymmetricBox';
        FWT_box_tip.Height=Param.FWT.Tip_Height;
        FWT_box_tip.Width=0.5*Param.FWT.Tip_Chord;
        
        FWT_box_tip.CoverThickness=Param.FWT.Thickness;
        FWT_box_tip.SparThickness=Param.FWT.Thickness;
        ...
        Param.Wing.Kink=Param.Wing.Kink*(1/Param.FWT.Fold_eta);
    ...
    Num_seg1=ceil(elnum*Param.Wing.Kink); % number of elements in the inboard section
    ...
    eta1_=linspace(0,Param.Wing.Kink, Num_sec1);
    eta2_=linspace(Param.Wing.Kink,1,Num_sec2);
