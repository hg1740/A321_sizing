...
Param.Wing.AR=13; % 10.172 for A321
...
PT_all.AR22=[pt1;pt2;pt3;pt4;pt5;pt6];
...
hold on 
plot(PT_all.AR19(:,2),PT_all.AR19(:,1)+27,'g-','LineWidth',1)
...
legend('Baseline model','AR = 13','AR = 16','AR = 19','AR = 22','Interpreter','latex','FontSize',12)
% figure 
% 
