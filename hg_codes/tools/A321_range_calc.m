...
%     Connector_right.AeroPanelLength=0.5;
    Connector_right.NumAeroPanel=12;
...
%     Connector_left.AeroPanelLength=0.5;
    Connector_left.NumAeroPanel=12;
...
%     Body.add(Verticalwing)
    ...
    run_folder = [
        'D:\MATLAB_workspace\Git_ALENA\ALENA-master\hg_codes\results\drag']; %[-], folder for exporting the NASTRAN model
...
% num=Y_pt;
% 
% fit_range=linspace(num(1),num(end),100);
% 
% spar=x(1:25);
% fit1=polyfit(num,spar,9);
% 
% spar_fit=polyval(fit1,fit_range);
% 
% figure 
% 
% plot(num,spar,'bs')
