function [Aircraft, Wingbox_right, FEM_full, Y_all, Box_dimensions, Box_CrossSec, Load_distribution, Wing_Delta, Root_Delta, Internal_Stresses]=Stress_Analysis_Fast(Param, run_folder)
    ...
    M_P2=max([Moment_P2_Loadcase1; Moment_P2_Loadcase2; Moment_P2_Loadcase3;  Moment_P2_Loadcase6; Moment_P2_Loadcase9; abs(Moment_P2_HingeLock')]);
    T=max([Torque_Loadcase1; Torque_Loadcase2; Torque_Loadcase3; Torque_Loadcase6; Torque_Loadcase9; abs(Torque_HingeLock')]);
    
    S_P1=max([Shear_P1_Loadcase1; Shear_P1_Loadcase2; Shear_P1_Loadcase3; Shear_P1_Loadcase6; Shear_P1_Loadcase9]);
    S_P2=max([Shear_P2_Loadcase1; Shear_P2_Loadcase2; Shear_P2_Loadcase3; Shear_P2_Loadcase6; Shear_P2_Loadcase9; abs(Shear_P2_HingeLock')]);
...
%         % Maximum forces used for sizing
%         M_P1=max([Moment_P1_Loadcase1; Moment_P1_Loadcase2; Moment_P1_Loadcase3;  Moment_P1_Loadcase6; Moment_P1_Loadcase9]);
%         M_P2=max([Moment_P2_Loadcase1; Moment_P2_Loadcase2; Moment_P2_Loadcase3;  Moment_P2_Loadcase6; Moment_P2_Loadcase9]);
%         T=max([Torque_Loadcase1; Torque_Loadcase2; Torque_Loadcase3; Torque_Loadcase6; Torque_Loadcase9]);
%         
%         S_P1=max([Shear_P1_Loadcase1; Shear_P1_Loadcase2; Shear_P1_Loadcase3; Shear_P1_Loadcase6; Shear_P1_Loadcase9]);
%         S_P2=max([Shear_P2_Loadcase1; Shear_P2_Loadcase2; Shear_P2_Loadcase3; Shear_P2_Loadcase6; Shear_P2_Loadcase9]);
%         
%     end
