...
%     Connector_left.AeroPanelLength=0.5;
  ...
  %% Wingbox 1 - right and control surf.
    ...
    Wingbox_right.TESweep_eta = [0, 0.27*fold_eta, 1];
...
%% Wingbox 2 - left and control surf.
    ...
    Wingbox_left.TESweep_eta = [0, 0.27*fold_eta, 1];
