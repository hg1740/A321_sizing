...
% 51-75 Astrg
% initial values
x=[ones(1,25)*0.05,ones(1,25)*0.002,ones(1,25)*1e-7];
...
while max(cond_set1)>1 
    ...
    cond_set2=[cond5,cond6,cond7,cond8];
...
data = h5read('D:\MATLAB_workspace\ALENA-master\ALENA-master\hg_codes\Sizing_analysis\Result\test8\A320_half_model_SOL144.h5','/NASTRAN/INPUT/NODE/GRID');
Y=data.X(2,346:370);
