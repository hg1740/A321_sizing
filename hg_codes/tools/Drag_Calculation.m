function [CDi,CD0,CL,k,Distribution,Load_distribution]=Drag_Calculation(Param, run_folder)
    ...
    if ~exist(strcat(run_folder,'\hinge_loacked'),'dir')
        
        mkdir(run_folder,'hinge_loacked')
    ...
    TrimLoadcase.Name = 'A321_36000ft_g_drag';
    ...
    trimFile = NastranMethods.writeTrimFile(Aircraft, TrimLoadcase,...
        MassCases,run_folder,'DatFilename','A321_36000ft_1g_drag',...
        'ExtraCards',aelink);
    ...
    Trim1_res=NastranMethods.extractNastranResults(strcat(run_folder,'\A321_36000ft_1g_drag.f06'),'ReadF06',true,'ReadHDF5',false);
    ...
    res_aeroF = mni.result.f06(strcat(run_folder,'/A321_36000ft_1g_drag.f06')).read_aeroF;
