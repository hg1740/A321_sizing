function [Aircraft, FEM_full, Wingbox_right, Box_dimensions, Box_CrossSec, Y_eta, varargout]=Aircraft_Models_v2(Param)
...
%% Wingbox 1 - right and control surf.
    ...
    if isfield(Param,'FWT')
        ...
        FWT_Strg=Param.FWT.Stringer_Area;
        ...
        [FWT_A_val,FWT_Iyy_val, FWT_Izz_val, FWT_J_val]=Beam_proeprties(FWT_Bwidth, FWT_Bheight, FWT_Spar_cap, FWT_Spar_web, FWT_Skin, FWT_Strg,Param.Wing.CapEta_width, Param.Wing.CapEta_height);
  ...
  %% Create discretised boxbeam with varied cross section prperties along the span 
    ...
    Thickness_spar_cap=Param.Wing.SparCap_Thickness;
    Thickness_spar_web=Param.Wing.SparWeb_Thickness;
    Thickness_skin=Param.Wing.Skin_Thickness;
    Area_strg=Param.Wing.Stringer_Area;
    ...
    [A_val,Iyy_val, Izz_val, J_val]=Beam_proeprties(Bwidth, Bheight, Thickness_spar_cap, Thickness_spar_web, Thickness_skin, Area_strg, Param.Wing.CapEta_width, Param.Wing.CapEta_height);
